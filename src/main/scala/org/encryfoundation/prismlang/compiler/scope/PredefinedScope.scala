...
import org.encryfoundation.prismlang.lib.predefined.decode.{Base58decode, SchemaDecode}
...
object PredefinedScope {
  ...
  val members: Seq[Symbol] = Seq(
    ...
    Symbol(SchemaDecode.name, Types.PFunc(SchemaDecode.args.toList, Types.POption(Types.SDObject)))
  )
}
