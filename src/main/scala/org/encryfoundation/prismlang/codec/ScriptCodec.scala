...
object ScriptCodec {
  ...
  implicit def dBaseObj = dT.bind[BaseObject.type](10)
  implicit def dObj = dT.bind[ArbitraryProduct](11)
  implicit def dStructTag = dT.bind[StructTag](12)
  implicit def dEncryProof = dT.bind[EncryProof.type](13)
  implicit def dEncryContract = dT.bind[EncryContract.type](14)
  implicit def dSig = dT.bind[Signature25519.type](15)
  implicit def dProp = dT.bind[EncryProposition.type](16)
  implicit def dMulSig = dT.bind[MultiSig.type](17)
  implicit def dEncryBox = dT.bind[EncryBox.type](18)
  implicit def dAssetBox = dT.bind[AssetBox.type](19)
  implicit def dAiBox = dT.bind[AssetIssuingBox.type](20)
  implicit def dDBox = dT.bind[DataBox.type](21)
  implicit def dUnlocker = dT.bind[EncryUnlocker.type](22)
  implicit def dTransact = dT.bind[EncryTransaction.type](23)
  implicit def dState = dT.bind[EncryState.type](24)
  implicit def dNit = dT.bind[Nit.type](25)
  ...
  implicit def dBoolOp = dExp.bind[Expr.Bool](6)
  implicit def dBin = dExp.bind[Expr.Bin](7)
  implicit def dUnary = dExp.bind[Expr.Unary](8)
  implicit def dCompOp = dExp.bind[Expr.Compare](9)
  implicit def dName = dExp.bind[Expr.Name](10)
  implicit def dCall = dExp.bind[Expr.Call](11)
  implicit def dAttr = dExp.bind[Expr.Attribute](12)
  implicit def dSubscr = dExp.bind[Expr.Subscript](13)
  implicit def dIntConst = dExp.bind[Expr.IntConst](14)
  implicit def dByteConst = dExp.bind[Expr.ByteConst](15)
  implicit def dStr = dExp.bind[Expr.Str](16)
  implicit def dCollConst = dExp.bind[Expr.Collection](17)
  implicit def dTupleConst = dExp.bind[Expr.Tuple](18)
  implicit def dBase58Str = dExp.bind[Expr.Base58Str](19)
  implicit def dBase16Str = dExp.bind[Expr.Base16Str](20)
  implicit def dTrue = dExp.bind[Expr.True.type](21)
  implicit def dFalse = dExp.bind[Expr.False.type](22)
  implicit def dSizeOf = dExp.bind[Expr.SizeOf](23)
  implicit def dExists = dExp.bind[Expr.Exists](24)
  implicit def dSum = dExp.bind[Expr.Sum](25)
  implicit def dMap = dExp.bind[Expr.Map](26)
